  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        At Green Galores, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, <span style={{color:'#ab47bc'}}>colorful</span> world.
      </p>
    </div>
  );
}
